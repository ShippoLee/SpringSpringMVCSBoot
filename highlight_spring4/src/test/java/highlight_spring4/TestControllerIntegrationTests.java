 ...
 * 它的属性指定的是Web资源的位置，默认为src/main/webapp，本例修改
 * 
 */
...
public class TestControllerIntegrationTests {
	...
	public void testRestController() throws Exception {
		...
		mockMvc.perform(get("/testRest")).andExpect(status().isOk())
				...
				.andExpect((ResultMatcher) content().contentType("text/plain;charset=UTF-8"))
				// 预期model里的值是demoService.saySomething()返回值Hello
				.andExpect((ResultMatcher) content().string(demoService.saySomething()));
	}
